    ...
    <div>
        ...
        <form method="post" action="index.php" enctype="multipart/form-data">
            ...
            <div class="my-3">
                ...
                <input class="form-control" type="number" name="txtluotxem" value="<?php echo $m["luotxem"]; ?>"
                       required>
            </div>
            <div class="my-3">
                <label>Lượt mua</label>
                <input class="form-control" type="number" name="txtluotmua" value="<?php echo $m["luotmua"]; ?>"
                       required>
            </div>
            <div class="my-3">
