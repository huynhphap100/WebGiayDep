            ...
            <div class="container px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link <?php if(!isset($_GET['action']) || $_GET['action'] != 'gioithieu') echo "active"; ?>" aria-current="page" href="index.php">Trang chính</a></li>
                        <li class="nav-item"><a class="nav-link <?php if(isset($_GET['action']) && $_GET['action'] == 'gioithieu') echo "active"; ?>" href="?action=gioithieu">Giới thiệu</a></li>
                    ...
                    <?php if(isset($_SESSION["khachhang"])){ ?>
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                            <li class="nav-item"><a class="nav-link text-warning bg-light" href="index.php?action=thongtin" >Chào <?php echo $_SESSION["khachhang"]["hoten"]; ?></a></li>
